...
/**
 * Script pour créer les tables de base de données nécessaires
 * Utilise pg directement pour être compatible avec les API routes
 */
...
async function createTables() {
  ...
  try {
    ...
    console.log('📊 Tables créées : users, products, orders, order_items, payments, reset_tokens');
